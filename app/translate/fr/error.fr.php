...
//  enum FrErreurMessage: string {
        //      case REQUIRE = 'le champ %s est requis';
        //      case EMAIL = 'le champ %s doit etre un email valide';
        //      case MIN_MAX = 'le champ %s doit contenir exactement %s caracteres';
